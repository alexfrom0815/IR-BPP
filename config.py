...
# dicPath = './data/dicPath/BoxMeshLargeArea.pt'
# dicPath = './data/dicPath/IrDicPath96.pt'

# dicPath = './data/dicPath/BlockMeshTolerance.pt'
# dicPath = './data/dicPath/IrDicPath.pt'
# dicPath = './data/dicPath/tetris3D23.pt'
# dicPath = './data/dicPath/256kMeshPose_50_clean_vhacd.pt'
# dicPath = './data/dicPath/IrDicPath_kpose50.pt'
