# exp0 baseline blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp0 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01

# exp1 naive rainbow blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp1 --previewNum 1 --actionType Uniform --num_processes 1  --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
...
# exp3 no distributed blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp3 --previewNum 1 --actionType Uniform --num_processes 16 --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
...
# exp5 no para actors blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp5 --previewNum 1 --actionType Uniform --num_processes 1 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
...
# exp9 HeuAction blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp9 --previewNum 1 --actionType HeuAction  --num_processes 16 --distributed --samplePointsNum 1024  --resolutionA 0.02 --resolutionH 0.01
...
# exp11 LineAction blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp11 --previewNum 1 --actionType LineAction --num_processes 16 --distributed --samplePointsNum 1024  --resolutionA 0.02 --resolutionH 0.01
...
# exp13 RotAction blockout
# python main.py --disable-cuda --device 0 --data_name blockout --custom exp13 --previewNum 1 --actionType RotAction  --num_processes 16 --distributed --samplePointsNum 1024  --resolutionA 0.02 --resolutionH 0.01
...
# exp15 200 action blockout 6629now
# python main.py --device 3 --data_name blockout --custom exp15 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 200 --resolutionA 0.02 --resolutionH 0.01
# python main.py --device 0 --data_name blockout --custom exp15 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 200 --resolutionA 0.02 --resolutionH 0.01
...
# exp17 double action resolution blockout 6629 now
# python main.py --device 2 --data_name blockout --custom exp17 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.01 --resolutionH 0.01
# python main.py --device 1 --data_name blockout --custom exp17 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.01 --resolutionH 0.01
...
# exp19 double height map resolution blockout 6629
# python main.py --disable-cuda --device 1 --data_name blockout --custom exp19 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.005
# python main.py --device 1 --data_name blockout --custom exp19 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.005
...
# exp21 double pointcloud size blockout 6629 now
# python main.py --device 3 --data_name blockout --custom exp21 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 2048 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
# python main.py --device 0 --data_name blockout --custom exp21 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 2048 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
...
# exp23 doubleRot blockout 6629
# python main.py --disable-cuda --device 1 --data_name blockout --custom exp23 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01 --doubleRot
# python main.py --device 1 --data_name blockout --custom exp23 --previewNum 1 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01 --doubleRot
...
# exp25 Pack it blockout 6630 to be continue or not
# python main.py --disable-cuda --device 3 --data_name blockout --custom exp25 --previewNum 10 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
# python main.py --device 0 --data_name blockout --custom exp25 --previewNum 10 --actionType Uniform --num_processes 16 --distributed --samplePointsNum 1024 --convexAction Defects --selectedAction 100 --resolutionA 0.02 --resolutionH 0.01
